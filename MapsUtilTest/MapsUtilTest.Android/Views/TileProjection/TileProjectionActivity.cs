...
namespace Sample.Droid.Views.TileProjection
{
    ...
    public class TileProjectionActivity : BaseActivity
    {
        ...
        {
            private List<Com.Google.Maps.Android.Geometry.Point> points = new List<Com.Google.Maps.Android.Geometry.Point>();
            ...
            public Tile GetTile(int x, int y, int zoom)
            {
                ...
                foreach (Com.Google.Maps.Android.Geometry.Point p in points)
                {
